...
$("#update1").click(function (e) {
    ...
    $("form input[required], form textarea[required]").each(function () {
        if (!$(this).val()) {
            ...
            $(this).after('<div class="invalid-feedback" style="color:#43c95f;">Bu alan boş bırakılamaz.</div>');
        } else {
    ...
    if (!emailValue || !validateEmail(emailValue)) {
        ...
        $("#Mail").after('<div class="invalid-feedback" style="color:#43c95f;">Geçerli bir email adresi girin.</div>');
    } else {
